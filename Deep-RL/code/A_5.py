...
def training(tf_random_seed, np_random_seed, mode, learning_rate, batch_size, optimizer, num_hidden_units):
    ...
    def store_data(store_dict):
        ...
        model_save_path = '../models/{}/{}_{}_{}_{}_{}_{}_{}_{}_store_dict.npy'.format(file_name, file_name, tf_random_seed, np_random_seed, mode, learning_rate, batch_size, optimizer, num_hidden_units)
    ...
    def save_model(sess):
        ...
        model_save_path = '../models/{}/{}_{}_{}_{}_{}_{}_{}_{}.checkpoint'.format(file_name, file_name, tf_random_seed, np_random_seed, mode, learning_rate, batch_size, optimizer, num_hidden_units)
            ...
            for learning_rate in [1e-4]:
                for batch_size in [128]:
                    for optimizer in ["RMS"]:
                        for num_hidden_units in [30, 1000]:
