...
def save_model(sess):
    tf.train.Saver().save(sess, '../models/TF_NN_128.checkpoint')
    print("model saved to {}".format('../models/TF_NN_128.checkpoint'))
...
def save_learning_curve(train_error_list, test_error_list, train_loss_list, test_loss_list):
    np.save("../models/TF_NN_128_train_error_list.npy", train_error_list)
    np.save("../models/TF_NN_128_test_error_list.npy", test_error_list)
    np.save("../models/TF_NN_128_train_loss_list.npy", train_loss_list)
    np.save("../models/TF_NN_128_test_loss_list.npy", test_loss_list)
...
# train the model according to cross entropy loss
