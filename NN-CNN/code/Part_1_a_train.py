...
def save_model(sess):
    tf.train.Saver().save(sess, '../models/TF_Linear.checkpoint')
    print("model saved to {}".format('../models/TF_Linear.checkpoint'))
...
def save_learning_curve(train_error_list, test_error_list, train_loss_list, test_loss_list):
    np.save("../models/TF_Linear_train_error_list.npy", train_error_list)
    np.save("../models/TF_Linear_test_error_list.npy", test_error_list)
    np.save("../models/TF_Linear_train_loss_list.npy", train_loss_list)
    np.save("../models/TF_Linear_test_loss_list.npy", test_loss_list)
