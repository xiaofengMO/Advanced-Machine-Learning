...
def save_model(numy_data):
    np.save('../models/NP_NN_128.npy', numy_data)
    print("model saved to {}".format('../models/NP_NN_128.npy'))
...
def save_learning_curve(train_error_list, test_error_list, train_loss_list, test_loss_list):
    np.save("../models/NP_NN_128_train_error_list.npy", train_error_list)
    np.save("../models/NP_NN_128_test_error_list.npy", test_error_list)
    np.save("../models/NP_NN_128_train_loss_list.npy", train_loss_list)
    np.save("../models/NP_NN_128_test_loss_list.npy", test_loss_list)
...
# define the model using one layer of 128 units
hidden_layer = [128]
